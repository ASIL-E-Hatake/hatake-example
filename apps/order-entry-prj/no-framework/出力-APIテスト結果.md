...
```http
GET http://localhost:3002/api/orders?orderStatus=draft&pageSize=50
```
...
```http
GET http://localhost:3002/api/orders?note=%E8%87%B3%E6%80%A5&pageSize=50
```
...
```http
GET http://localhost:3002/api/orders?sortField=orderDate&sortAscending=false&pageSize=50
```
...
```http
GET http://localhost:3002/api/orders?totalAmount=5000&totalAmount=11000&pageSize=50
```
...
```http
GET http://localhost:3002/api/orders/SO2026090002
```
...
```http
GET http://localhost:3002/api/orders?pageSize=50
```
...
```http
PUT http://localhost:3002/api/orders/SO2026070001
...
```http
GET http://localhost:3002/api/order-lines?orderNo=SO2026090002&pageSize=200
```
...
```http
GET http://localhost:3002/api/order-lines?pageSize=200
```
...
```http
POST http://localhost:3002/api/orders/SO2026090001/ship
```
...
```http
GET http://localhost:3002/api/definition.yaml
```
